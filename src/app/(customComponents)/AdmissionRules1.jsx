      ...
      <div className="my-3">
        ...
        <div className="w-full overflow-x-auto my-4">
          <Table className="min-w-[700px] text-sm">
            <TableHeader>
              <TableRow>
                <TableHead className="w-[50px]  bg-gray-200">
                  №
                </TableHead>
        ...
        <p>{t("p-8")}</p>
        <p>{t("p-9")}</p>
        <p className="text-xl font-bold  my-4">{t("p-11")}</p>
        <p>{t("p-12")}</p>
        <p className="text-xl font-bold  my-4 whitespace-pre-line">
          {t("p-13")}
        </p>

        <p>{t("p-14")}</p>
        <p className="text-xl font-bold  my-4">{t("p-15")}</p>
        <p>{t("p-16")}</p>
        <p className="text-xl font-bold  my-4">{t("p-17")}</p>
        <p>{t("p-18")}</p>
...
export default AdmissionRules1;
